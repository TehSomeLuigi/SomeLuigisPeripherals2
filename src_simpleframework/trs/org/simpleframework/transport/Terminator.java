...
import trs.org.simpleframework.util.thread.Daemon;

/**
 * The <code>Terminator</code> object allows termination of the 
...
class Terminator extends Daemon {
   ...
   /**
    * Constructor for the <code>Terminator</code> object. For an
