...
/**
 * The <code>SegmentBuilder</code> object is used to build segments
 ...
 *
 * @see trs.org.simpleframework.transport.Writer
 */
class SegmentBuilder {
   ...
   /**
    * Constructor for the <code>SegmentBuilder</code> object. This 
    ...
    * the <code>Writer</code> to block. Blocking is required so
    ...
    * using the <code>aggregate</code> method. If the length is zero
   ...
   /**
    * The <code>Queue</code> object is used to create a queue of
