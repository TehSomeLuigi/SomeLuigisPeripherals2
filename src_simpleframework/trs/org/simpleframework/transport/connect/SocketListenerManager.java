 ...
 * 
 * @see trs.org.simpleframework.transport.connect.SocketConnection
 */
class SocketListenerManager extends HashSet<SocketListener> implements Closeable {
   ...
   /**
    * This is the tracer used to create a trace for the sockets.
    */
    ...
    * @param agent this is the agent used to trace socket events
    */
   ...
   public SocketAddress listen(SocketAddress address, SSLContext context) throws IOException {
      SocketListener listener = new SocketListener(address, context, server, agent);
