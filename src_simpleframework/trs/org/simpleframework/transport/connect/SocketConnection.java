 ...
 * 
 * @see trs.org.simpleframework.transport.Server
 */
public class SocketConnection implements Connection {
    ...
    * 
    * @param server this is the processor that receives requests
    * @param agent this is used to create a trace for the socket
    */    
   public SocketConnection(Server server, Agent agent) throws IOException {
      this.manager = new SocketListenerManager(server, agent);
      this.server = server;
   }
