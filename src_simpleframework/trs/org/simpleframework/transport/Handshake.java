...
package trs.org.simpleframework.transport;

import static java.nio.channels.SelectionKey.OP_READ;
import static java.nio.channels.SelectionKey.OP_WRITE;
import static trs.org.simpleframework.transport.Status.CLIENT;
import static trs.org.simpleframework.transport.Status.DONE;
import static trs.org.simpleframework.transport.Status.SERVER;
import static trs.org.simpleframework.transport.TransportEvent.ERROR;
import static trs.org.simpleframework.transport.TransportEvent.HANDSHAKE_BEGIN;
import static trs.org.simpleframework.transport.TransportEvent.HANDSHAKE_DONE;
import static trs.org.simpleframework.transport.TransportEvent.READ;
import static trs.org.simpleframework.transport.TransportEvent.WRITE;
...
import trs.org.simpleframework.transport.trace.Trace;
 ...
 *
 * @see trs.org.simpleframework.transport.Negotiator
 */
class Handshake implements Negotiation {
   ...
   private Runnable process() throws IOException {
      ...
      if(require == CLIENT) {
         return new Client(this, trace);
      } 
      if(require == SERVER) {
         return new Server(this, trace);
      } 
      return new Done(this, trace);
   }
   ...
   private class Done extends Task {
       ...
       */
      public Done(Negotiation state, Trace trace) {
   ...
   private class Client extends Task {
       ...
       * @param trace the trace that is used to monitor the handshake        
       */
      public Client(Negotiation state, Trace trace) {
         super(state, negotiator, trace, OP_READ);
      }
   ...
   private class Server extends Task {
       ...
       * @param trace the trace that is used to monitor the handshake        
       */
      public Server(Negotiation state, Trace trace) {
