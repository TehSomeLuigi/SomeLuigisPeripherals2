...
import trs.org.simpleframework.http.Part;
import trs.org.simpleframework.http.Query;
...
class RequestEntity extends RequestMessage implements Request {
   ...
   /**
    * This is used to acquire the SSL security session used when the
   ...
   public SSLSession getSecuritySession() {
      SSLEngine engine = channel.getEngine();
