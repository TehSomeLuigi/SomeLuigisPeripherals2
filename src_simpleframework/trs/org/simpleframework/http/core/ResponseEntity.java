...
import static trs.org.simpleframework.http.core.ContainerEvent.WRITE_HEADER;
...
import trs.org.simpleframework.http.message.Entity;
import trs.org.simpleframework.transport.Channel;
import trs.org.simpleframework.transport.Sender;
...
class ResponseEntity extends ResponseMessage implements Response {   
   ...
   /**
    * This is the monitor that is used to monitor the response.
    */
   ...
   public ResponseEntity(Request request, Entity entity, Monitor monitor) {
      ...
      this.buffer = new ResponseBuffer(this, support, entity, monitor);
   ...
   public void setContentLength(long length) {
      setValue(CONTENT_LENGTH, String.valueOf(length));      
   }
