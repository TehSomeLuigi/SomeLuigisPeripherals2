...
class ResponseBuffer extends OutputStream implements WritableByteChannel {
    ...
    */ 
   public ResponseBuffer(Response response, Conversation support, Entity entity, Monitor monitor) {
    ...
    * @param monitor this is used to report I/O events to the kernel    
    */       
   public ResponseBuffer(Response response, Conversation support, Channel channel, Monitor monitor) {
