...
package trs.org.simpleframework.http.core;

import static trs.org.simpleframework.http.Method.HEAD;
import static trs.org.simpleframework.http.Protocol.CHUNKED;
import static trs.org.simpleframework.http.Protocol.CLOSE;
import static trs.org.simpleframework.http.Protocol.CONNECTION;
import static trs.org.simpleframework.http.Protocol.CONTENT_LENGTH;
import static trs.org.simpleframework.http.Protocol.KEEP_ALIVE;
import static trs.org.simpleframework.http.Protocol.TRANSFER_ENCODING;
import trs.org.simpleframework.http.RequestHeader;
import trs.org.simpleframework.http.ResponseHeader;
 ...
 *
 * @see trs.org.simpleframework.http.core.ResponseBuffer
 * @see trs.org.simpleframework.http.core.Transfer
 */
public class Conversation {
   ...
   public void setIdentityEncoded() {
      response.remove(TRANSFER_ENCODING);
   }
