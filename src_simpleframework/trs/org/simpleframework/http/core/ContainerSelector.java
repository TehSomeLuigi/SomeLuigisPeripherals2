...
import trs.org.simpleframework.transport.TerminateException;
import trs.org.simpleframework.transport.reactor.ExecutorReactor;
import trs.org.simpleframework.transport.reactor.Reactor;
import trs.org.simpleframework.util.buffer.Allocator;
import trs.org.simpleframework.util.thread.PoolExecutor;
...
class ContainerSelector implements Selector {  
   ...
   public void start(Channel channel) throws IOException {
      start(new Collector(allocator, channel));    
   }
