...
import static trs.org.simpleframework.http.Protocol.BOUNDARY;
import static trs.org.simpleframework.http.Protocol.CHUNKED;
import static trs.org.simpleframework.http.Protocol.MULTIPART;
...
class ConsumerFactory {
   ...
   public BodyConsumer getInstance(long length) {      
      ...
      if(isPart(segment)) { 
         return new PartSeriesConsumer(allocator, boundary, length);
      }
