 ...
 * 
 * @see trs.org.simpleframework.http.message.PartSeriesConsumer
 */
class PartEntryFactory {   
    ...
    */
   public PartEntryFactory(Allocator allocator, PartSeries series, byte[] terminal) {
   ...
   public PartEntryConsumer getInstance() {
      return new PartEntryConsumer(allocator, series, terminal);
   }
}