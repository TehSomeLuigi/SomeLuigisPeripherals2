...
import trs.org.simpleframework.util.buffer.BufferAllocator;
...
public class PartSeriesConsumer implements BodyConsumer {
   ...
   public PartSeriesConsumer(Allocator allocator, PartSeries series, byte[] boundary, long length) {
      ...
      this.consumer = new PartEntryConsumer(buffer, series, boundary);
      this.factory = new PartEntryFactory(buffer, series, boundary);
      this.series = series;
   }
