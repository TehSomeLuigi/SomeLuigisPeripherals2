...
import trs.org.simpleframework.util.parse.MapParser;
 ...
 * the <code>trs.org.simpleframework.http.net.Query</code> interface. The
...
public class QueryParser extends MapParser<String> implements Query {
    ...
    * <code>trs.org.simpleframework.util.net.Query</code>.    
    */
   public QueryParser(){
      this.name = new Token();
