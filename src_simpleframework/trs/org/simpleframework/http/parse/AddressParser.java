...
package trs.org.simpleframework.http.parse;

import trs.org.simpleframework.http.Address;
import trs.org.simpleframework.http.Path;
import trs.org.simpleframework.http.Query;
import trs.org.simpleframework.util.KeyMap;
import trs.org.simpleframework.util.parse.Parser;
...
public class AddressParser extends Parser implements Address {
    ...
    * <p>
    * This returns a <code>trs.org.simpleframework.http.Query</code> 
    ...
    * then the <code>toString</code> method would produca a string 
    ...
    *
    * </pre></code>
    * This syntax is sufficent to handle HTTP style URI's as well
    ...
    * determine the valididity of cetain <code>chars</code>
    * within a Uniform Resource Identifier. RFC 2396 defines
    * an unreserverd char as <code>alphanum | mark</code>.
    *
